    ...
    public static void main(String[] args) {
     ...
     // SÂN KHẤU RA MẮT
        ...
        System.out.println("////////////////////////CÔNG DIỄN 1///////////////////////////");
        	...
        	dsNguHanh.add(huyR);
            dsNguHanh.add(giaHuy);
            dsNguHanh.add(vanTruong);
        ...
        Nhom nhaTinhTu = new Nhom("Tinh Tú", tinhTu, dsBaiHatChungCD2,4620, bangDiemCaNhanTT,dinhTienDat);
        //Kame
        ...
        Nhom nhaKame = new Nhom("Kame", kame, dsBaiHatChungCD2,3350, bangDiemCaNhanKM,kayTran);
        //Phát Tài
        ...
        System.out.println(nhaKame.getDsAnhTai().size());
        dsNhaCD2.add(nhaPhatTai);
        dsNhaCD2.add(nhaTinhTu);
        ...
        congDien2.loaiThanhVienCD2(dsNhaCD2, dsAnhTaiBiLoai);
        System.out.printf("| %-15s | %-100s | %-10s | %-8s | %-12s |\n", "Tên nhà", "Bài hát biểu diễn (Tác giả)", "Thành viên", "Điểm Nhóm", "Điểm hỏa lực cá nhân");
        ...
        System.out.println("Danh sách 3 anh tài bị loại sau công diễn 2 \n "+ dsAnhTaiBiLoai);
        System.out.println("////////////////////////Công diễn 3///////////////////////////");
        System.out.println("Do Tinh Tú xếp vị trí thử 2 nên Sao Sáng và Tái Sinh giữ nguyên đội hình");
        Nhom nhaCaLon = nhaTinhTu;
        nhaCaLon.setTenNhom("Cá Lớn");
        nhaCaLon.setDiemBinhChon(3530);
        Nhom nhaMutGung = nhaKame;
        nhaMutGung.setTenNhom("Mứt Gừng");
        nhaMutGung.setDiemBinhChon(3470);
        Nhom nhaChinhMuoi = nhaCuuLong;
        nhaChinhMuoi.setTenNhom("Chín muồi");
        nhaChinhMuoi.setDiemBinhChon(3510);
        Nhom nhaTre = nhaPhatTai;
        nhaTre.setTenNhom("Trẻ");
        nhaTre.setDiemBinhChon(3410);
        ArrayList<Nhom> dsNhaCD3 = new ArrayList<>();
        dsNhaCD3.add(nhaCaLon);
        dsNhaCD3.add(nhaChinhMuoi);
        dsNhaCD3.add(nhaTre);
        dsNhaCD3.add(nhaMutGung);
        CongDien congDien3 = new CongDien("3", "Tấm Khiên", dsNhaCD3, "vote", bangDiemBinhChonCaNhan, bangDiemHoaLucCaNhan);
        congDien3.loaiThanhVienCD3(dsNhaCD3, dsAnhTaiBiLoai);
        System.out.printf("| %-15s | %-100s | %-10s | %-8s | %-12s |\n", "Tên nhà", "Bài hát biểu diễn (Tác giả)", "Thành viên", "Điểm Nhóm", "Điểm hỏa lực cá nhân");
        for(Nhom nha : dsNhaCD3) {
            for (AnhTai anhtai : nha.getDsAnhTai()) {
                int diemBanDau = nha.getDiemBinhChon();
                System.out.printf("| %-15s | %-60s | %-50s | %-12d | %-14d |\n",
                        nha.getTenNhom(),
